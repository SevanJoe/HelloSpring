...
//        testFactoryBean(beanFactory);
    ...
    private static void testAnnotation() {
        ...
        AnnotationBean annotationBean = applicationContext.getBean("baseBean", AnnotationBean.class);
    ...
    private static void testEvent() {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("beans/beanevent.xml");
